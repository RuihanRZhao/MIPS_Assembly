.data
input_file_name: .asciiz "C:\Users\Ryen\GitHub\MIPS_Assembly\CourseWork\CW_Q5\in.ppm"
output_file_name: .asciiz "C:\Users\Ryen\GitHub\MIPS_Assembly\CourseWork\CW_Q5\out.ppm"
...
li   $a1, 1     # flag for (creating if not exists and) writing
li   $a2, 0    # access mode of the file is set to "-rw-r--r--"
